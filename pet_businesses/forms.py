...
class PetBusinessForm(forms.ModelForm):
    ...
    class Meta:
        ...
        help_texts = {
            ...
            'linkedin': 'Enter the full LinkedIn profile URL '
            '(e.g. https://linkedin.com/in/yourname)',
            'facebook': 'Enter the full Facebook page URL '
            '(e.g. https://facebook.com/yourpage)',
            'instagram': 'Enter the full Instagram profile URL '
            '(e.g. https://instagram.com/yourhandle)',
            'tiktok': 'Enter the full TikTok profile URL '
